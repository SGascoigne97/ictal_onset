...
The code in this repository can be used to automatically detect onsets using the imprint, Epileptigenicity Index (Bartolomei et al., 2008), and Phase-Locked High-Gamme (Weiss et al., 2015) algortihms
