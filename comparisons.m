...
save_table = 0;
save_plot = 0;
atl_id =  [72; 120; 250; 500];
col_id = [1;2;3;4];
% atl_tab = table(atl_id, col_id);
atl = 2;
chan_or_roi = sprintf("roi_%d", atl_id(atl));

comparison = "resection"; %, "pairwise"]
det_method = "imprint"; % "CLO", "EI", "PLHG"
...
for pat = 1:length(patients)
    ...
    haus_table = calc_haus(pat_onset, atlas(atl,:), "det_method", det_method,...
        "comparison", comparison, "chan_or_roi", chan_or_roi);
