...
data_location = '/media/b5007876/DATA/Data/UCLH_export/imprintDataExport';
path_pipeline_exports = '/media/b5007876/DATA/Data/UCLH_export/imprintDataExport/export_ictal';
patient = 'UCLH1200';
...
recorded_channels = channel_details(contains(channel_details.chan_name, data_export.segment_channel_labels{1}),:);
...
recorded_xyz = xyz(find(contains(atlas.name{3,1}, recorded_regions)),:);
resected_xyz = xyz(find(contains(atlas.name{3,1}, resected_regions)),:);
